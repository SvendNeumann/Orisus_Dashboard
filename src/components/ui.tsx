...
export function Card({
  ...
  return (
    <div
      className={cn(
        "rounded-lg border border-white/16 bg-[linear-gradient(145deg,rgba(18,49,69,0.94),rgba(11,35,52,0.86))] text-card-foreground shadow-[0_18px_54px_rgba(0,0,0,0.20)] backdrop-blur-xl",
        className
      )}
      {...props}
    />
...
export function Select({
  ...
  return (
    <select
      className={cn(
        "h-10 rounded-md border border-[#b2e2e5]/35 bg-white/95 px-3 pr-9 text-center text-sm font-semibold text-slate-950 shadow-sm outline-none transition focus:border-[#30d5c8] focus:ring-4 focus:ring-[#30d5c8]/15",
        className
      )}
      {...props}
    >
