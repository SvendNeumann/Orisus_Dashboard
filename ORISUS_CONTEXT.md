...
- Lohnjournal / DATEV-Personalkosten:
  ...
  - Weitere Lohnjournal-Standort-Aliase: `krauhausen` gehoert zu Huettenberg, `krause` gehoert zu Essen, `zorn de bulach`/`zdb` gehoert zu Kehl, `hangx` gehoert zu Ulmet. Diese Aliaslogik darf fuer Ordner-/Dateinamen und PDF-Text genutzt werden, wenn die DATEV-Kopfzeile keinen App-Standort liefert.
