...
- Lohnjournal / DATEV-Personalkosten:
  ...
  - Aeltere Kallweit-/Kirchberg-Lohnjournal-PDFs ohne moderne `Personalkostenuebersicht` duerfen ueber einen Altformat-Fallback gelesen werden: Mitarbeiter, Brutto und Arbeitgeber-Zusatzkosten kommen aus den Einzelabrechnungsseiten, AAG-Erstattungen aus der Erstattungsuebersicht. Der Importbericht weist diesen Fallback als neutralen Hinweis aus.
